    ...
    public class JSONNode
    {
        ...
        internal static string Escape(string aText)
        {
            ...
            foreach (char c in aText)
            {
                switch (c)
                {
                    case '\\': sbResult.Append("\\\\"); break;
                    case '\"': sbResult.Append("\\\""); break;
                    case '\n': sbResult.Append("\\n"); break;
                    case '\r': sbResult.Append("\\r"); break;
                    case '\t': sbResult.Append("\\t"); break;
                    case '\b': sbResult.Append("\\b"); break;
                    case '\f': sbResult.Append("\\f"); break;
                    default: sbResult.Append(c); break;
                }
            }
    ...
    public class JSONClass : JSONNode, IEnumerable
    {
        ...
        public override string ToString()
        {
            ...
            foreach (KeyValuePair<string, JSONNode> N in m_Dict)
            {
                    ...
                    sbResult.Append("\"");
                    sbResult.Append(Escape(N.Key));
                    sbResult.Append("\":");
                    sbResult.Append(N.Value.ToString());
            }
